		...
		Platform.runLater(() -> {
			...
			result.ifPresent(objectProperty -> {
				try {
					...
					try {
						this.simul.setObject(new Cube(MainObject.DEFAULT_MASS, 0, 0, 0, Cube.MAX_SIZE * 0.3));
					} catch (Exception e1) {
						e1.printStackTrace();
					}
