...
public class ControlPanelController {
	...
	private void showObjectPane() {
		...
		try {
			...
			loader.setLocation(getClass().getResource("/hedspi/group01/force/view/ObjectPanel.fxml"));
	...
	private void showForcePane() {
		...
		try {
			FXMLLoader loader = new FXMLLoader();
			loader.setLocation(getClass().getResource("/hedspi/group01/force/view/ForcePanel.fxml"));
	...
	private void showSurfacePane() {
		...
		try {
			FXMLLoader loader = new FXMLLoader();
			loader.setLocation(getClass().getResource("/hedspi/group01/force/view/SurfacePanel.fxml"));
